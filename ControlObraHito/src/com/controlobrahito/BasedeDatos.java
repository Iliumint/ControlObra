...
import clases_estructuras.EstrucClimaYPersonal;
...
import clases_estructuras.EstrucRellenosObras;
...
public class BasedeDatos {
	...
	public boolean INSERTAR_EN_MOVIMIENTO_MATERIALES(EstrucMoviemientoMateriales event)
	{
		...
		db.close();		
		Log.e("INSERCION","Se hizo la insercion Correctamente");
		return true;
		}
		catch(Exception e)
		{
	...
	public boolean INSERTAR_EN_MAQUINARIA(EstrucMaquinaria event)
	{
		...
		ins.put("UNIDAD_DE_MEDIDA", event.getUnidadMedida());
		...
		Log.e("UNIDAD_DE_MEDIDA", event.getUnidadMedida());
